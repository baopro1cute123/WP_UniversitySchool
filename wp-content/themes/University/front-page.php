...
<div class="full-width-split group">
    <div class="full-width-split__one">
        <div class="full-width-split__inner">
            ...
            <?php
                $today = date('Ymd');
                $EventHomePages = new WP_Query( array (
                'posts_per_page' => 2,
                'post_type' => 'event',
                ...
                // lấy các sự kiện value >= ngày hôm nay !
            ));

            if ($EventHomePages -> have_posts()){
                while ($EventHomePages->have_posts()){
                    $EventHomePages->the_post();
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
            ...
            <?php
                $blogHomePages = new WP_Query( array ('posts_per_page' => 2,
                'post_type' => 'post',
                'order' => 'ASC'
            ));

            if ($blogHomePages -> have_posts()){
                while ($blogHomePages->have_posts()){
                    $blogHomePages->the_post();
                    ?>
            ...
            <div class="event-summary">
                ...
                <div class="event-summary__content">
                    ...
                    <p><?php echo wp_trim_words( get_the_content(), 25 ); ?> <a href="<?php the_permalink(); ?>"
...
<div class="hero-slider">
    <div data-glide-el="track" class="glide__track">
        <div class="glide__slides">
            <!-- <?php
                $SlideHomePages = new WP_Query( array (
                'posts_per_page' => 3,
                'post_type' => 'slide',
                'order' => 'ASC'
            ));
            var_dump($SlideHomePages);
