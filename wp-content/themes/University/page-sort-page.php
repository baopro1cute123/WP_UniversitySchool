...
function myFunction(e) {
    var giatri = document.getElementById("select_sort")
        .value; //lấy giá trị value thông qua các option từ select : select_sort
    ...
    switch (giatri) {
        ...
        case "asc":
            ...
            break;
        default:
            let total = fetch("https://pegasus.edu.vn/wp-json/wp/v2/posts").then((response) => response.json()).then((
                data) => {
                kq = data;
                inKetqua(kq);
            })
